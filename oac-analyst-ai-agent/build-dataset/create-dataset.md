...
* Enhance and Transform the Dataset using AI Assistant
* Prepare the Dataset for Use with the AI Assistant


### Prerequisites 

This lab assumes you have:
* Basic understanding of data wrangling concepts
...
## Task 2:  Enhance and Transform the Dataset using AI Assistant
...
3. Switch the view from data to **Metadata** to verify each column data type and aggregation 
 ...
 ![Verify Data Types](images/builddataset6.png)
  ...
  > **Note:** You can also add business descriptions to each column that helps the LLMs and also Hide any columns that are not needed

4. Switch back to Data view, then **Click Recommendations** , scroll down and **Click** Extract Year from Order Date
...
## Task 3:  Prepare the Dataset for Use with the AI Assistant
...
## Learn More
* [Enrich and Transform Data](https://docs.oracle.com/en/cloud/paas/analytics-cloud/acubi/enrich-and-transform-data.html)
