...
Prerequisite: 
- Ideally, you should be familiar with the base concepts of ODA before to start the lab. If not, please read this page to learn the base terminology: [Digital Assistant Overview](https://docs.oracle.com/en/cloud/paas/digital-assistant/use-chatbot/overview-digital-assistants-skills.html).
