...
![ADB details page database actions button](images/adb10.png)
2. Click the "Create User" button on the right side of the page.<br>
![ADB users page](images/adb11.png)
...
![Form for creating ADB user](images/adb12.png)
4. Click the "ADMIN" profile button in the top right of the page, and select "Sign Out".<br>
![Selecting person silhouette, then sign out](images/adb13.png)
...
![Selecting ADB database actions button, then SQL](images/adb17.png)
...
![ADB SQL worksheet](images/adb16.png)
