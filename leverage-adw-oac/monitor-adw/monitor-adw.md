...
3.  Save Project as Training01 (or any name we choose). Type **Name**: **Training01** an Click **Save** button.
    ...
    ![Save Project](../monitor-adw/images/save-projectsmall.png =400x*)

4.  OAC **Query Log**  
Lets now check the query logs generated inside of OAC.  
Click **Go Back** left arrow from upper left of the screen to go to the Analytics Home Page. ![Go Back](../monitor-adw/images/gobacksmall.png =250x*)

5.  Click **Navigator** and then Select **Console**.

    ![Console](../monitor-adw/images/navigator-consolesmall.png =250x*)
...
8.  Sort the query log in a descending order.  
   **Sort By**> Select **Creation Time Descending**.
...
13. Go back to **Console** ![Go Back](../monitor-adw/images/goback-console.png =250x*) and Click **Issue SQL** under _Configuration and Administration_ section.  
...
16. Go to the ADW **Details Page > Performance Hub > SQL ID**, select your query SQL ID.

     ![Show Details](../monitor-adw/images/adwshowdetails.png)

17. Click the **SQL Text** tab.

     ![Overview](../monitor-adw/images/adwshowdetails2.png)

18. You can also browse through the other tabs. Click the **Summary** tab to see your **Plans** information.
...
In the **Home** page, click the user icon, then click **Profile**.
     ...
     ![Profile](../monitor-adw/images/profile.png =250x*)
...
On the **Home** page, click **Training 01** workbook.
     ...
     ![Workbook](../monitor-adw/images/open-workbook.png =250x*)
...
5. We are going to focus on **Performance Tools** tab from lower left, to review performance statistics in the current workbook. You may want to Click **Refresh Data** ![Refresh Data](../monitor-adw/images/refresh-data.png =250x*) to get the latest statistics.  
