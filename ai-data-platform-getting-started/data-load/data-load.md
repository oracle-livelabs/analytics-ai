...
> [DELTA\_CREATE\_TABLE\_WITH\_NON\_EMPTY\_LOCATION] Cannot create table ('`f1\_bronze`.`bronze`.`f1\_lap\_times\_dlt`'). The associated location ('oci://IDL-458725532-1692497c19be4c739c68aec2e436a825@fro8fl9kuqli/1692497c19be4c739c68aec2e436a825.cat/bronze.db/f1\_lap\_times_dlt') is not empty and also not a Delta table.]
> or
...
Right of the folder name (in this example f1_results_dlt or f1_lap_times_dlt) at the 3 ... you have the option to delete that particular folder. please do so and run the notebook that loads that file in the delta table again.
