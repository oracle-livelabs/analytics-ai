...
2. Enter the catalog name **supplier** using lowercase letters. Leave the **Catalog type** as **Standard catalog**. Select the same compartment your other lab assets are in and select **Create**. The notebooks in the next lab reference the lowercase catalog name exactly.
