...
prompt APPLICATION 100 - OCI Wingmate Compute Page
--
-- Application Export:
--   Application:     100
--   Name:            OCI Wingmate Compute Page
...
wwv_flow_imp_page.create_page(
 p_id=>5
,p_name=>'OCI Compute Wingmate'
,p_alias=>'OCI-COMPUTE-WINGMATE'
,p_step_title=>'OCI Compute Wingmate'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25014437977637139)
