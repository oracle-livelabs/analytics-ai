...
In the next workshop (this is a part 2 from a 3-part-series workshop), we'll learn how to use other AutoML tools to extend, visualize and improve the NN (and other models).
